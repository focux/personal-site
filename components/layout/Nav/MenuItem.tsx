...
const MenuItem: React.FC<MenuItem> = ({ children, className, active }) => {
  const containerClassName = classNames({
    ...
    [className]: className!!,
    'font-semibold uppercase text-base tracking-widest cursor-pointer hover:text-primary-500 transiton ease-out duration-150 border-b-2 border-transparent hover:border-primary-500': true,
  });
